        ...
        <div class="container-principal">
            ...
            <div class="formulario" >
                ...
                <form id="form-login" method="post" action="teste.php">
                    ...
                    <input type="text" placeholder="Email:" name="email" required="true" minlength="3" maxlength="50">
                    ...
                    <input type="submit"  name = "btnEntrar" value="Entrar"> <br><br>
                </form>
                
                <a href="index.php">Já tem Cadastro? Clique aqui</a><br><br>
                <a href="alteruser.php">Quer Alterar o Nome? Clique aqui</a><br><br>
                <a href="deleteuser.php">Quer DELETAR o usuario? Clique aqui</a><br><br>
            </div>
        </div>
    </body>
</html>